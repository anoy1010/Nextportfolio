            ...
            <div>
                <div className='flex items-center justify-between w-[450px]'>
                    ...
                    <div className='flex flex-col gap-6 text-[#051c24]-600'>
                        <div>10/10/****</div>
                        <div>University Virtual of Ivory Coast</div>
                        <div>Master I</div>
                ...
                <div className='max-w-[800px]'>
                    ...
                    <p className='text-[#007198]'>
                         All of the examples in Tailwind UI rely on the default Tailwind CSS configuration, but some rely on additional first-party plugins like, aspect-ratio.
