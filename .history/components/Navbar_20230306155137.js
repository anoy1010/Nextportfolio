...
import {FiDownload} from 'react-icons/tfi'
  ...
  return (
    <div className='bg-white fixed top-0 w-[100%] z-10 '>
        <div className='container mx-auto flex justify-between items-center py-4'>
            ...
            <a href='#' className='flex border border-[#04bbff] px-4 py-1 text-[#04bbff] rounded-[5px] items-center gap-2 hover:bg-[#04bbff] hover:text-white transition duration-200 '>
                Télécharger mon CV
                <FiDownload/>
